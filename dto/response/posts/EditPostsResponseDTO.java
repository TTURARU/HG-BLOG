...
@Getter
public class EditPostsResponseDTO extends ResponseDTO {
    //# 생성자
    private EditPostsResponseDTO(){
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    //# success
    public static ResponseEntity<EditPostsResponseDTO> success() {
        EditPostsResponseDTO result = new EditPostsResponseDTO();
